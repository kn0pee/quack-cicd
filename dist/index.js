...
const utils_1 = __nccwpck_require__(6748);
/**
 * Commands
 *
 * Command Format:
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const command_1 = __nccwpck_require__(2544);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__export(__nccwpck_require__(6944));
...
const debug_1 = __importDefault(__nccwpck_require__(7751));
...
module.exports = __nccwpck_require__(5041)(exports);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(8979);
} else {
	module.exports = __nccwpck_require__(3055);
}
...
const Git = __nccwpck_require__(5029);
const {GitConstructError} = __nccwpck_require__(8940);
const {PluginStore} = __nccwpck_require__(3968);
const {commandConfigPrefixingPlugin} = __nccwpck_require__(8893);
const {createInstanceConfig, folderExists} = __nccwpck_require__(568);

const api = Object.create(null);
for (let imported = __nccwpck_require__(8940), keys = Object.keys(imported), i = 0; i < keys.length; i++) {
   const name = keys[i];
   if (/^[A-Z]/.test(name)) {
...
const {GitExecutor} = __nccwpck_require__(2405);
const {SimpleGitApi} = __nccwpck_require__(121);

const {Scheduler} = __nccwpck_require__(4290);
const {GitLogger} = __nccwpck_require__(682);
const {adhocExecTask, configurationErrorTask} = __nccwpck_require__(1594);
const {
   NOOP,
   asArray,
   filterArray,
...
const {applyPatchTask} = __nccwpck_require__(9163)
const {branchTask, branchLocalTask, deleteBranchesTask, deleteBranchTask} = __nccwpck_require__(8109);
const {checkIgnoreTask} = __nccwpck_require__(6517);
const {checkIsRepoTask} = __nccwpck_require__(4511);
const {cloneTask, cloneMirrorTask} = __nccwpck_require__(1437);
const {addConfigTask, listConfigTask} = __nccwpck_require__(2235);
const {cleanWithOptionsTask, isCleanOptionsArray} = __nccwpck_require__(2520);
const {commitTask} = __nccwpck_require__(851);
const {diffSummaryTask} = __nccwpck_require__(9629);
const {fetchTask} = __nccwpck_require__(5739);
const {hashObjectTask} = __nccwpck_require__(446);
const {initTask} = __nccwpck_require__(5413);
const {logTask, parseLogOptions} = __nccwpck_require__(7676);
const {mergeTask} = __nccwpck_require__(9965);
const {moveTask} = __nccwpck_require__(4461);
const {pullTask} = __nccwpck_require__(9793);
const {pushTagsTask} = __nccwpck_require__(7560);
const {addRemoteTask, getRemotesTask, listRemotesTask, remoteTask, removeRemoteTask} = __nccwpck_require__(8963);
const {getResetMode, resetTask} = __nccwpck_require__(3972);
const {stashListTask} = __nccwpck_require__(7514);
const {statusTask} = __nccwpck_require__(4618);
const {addSubModuleTask, initSubModuleTask, subModuleTask, updateSubModuleTask} = __nccwpck_require__(2568);
const {addAnnotatedTagTask, addTagTask, tagListTask} = __nccwpck_require__(7243);
const {straightThroughBufferTask, straightThroughStringTask} = __nccwpck_require__(1594);
...
const {gitP} = __nccwpck_require__(880);
const {esModuleFactory, gitInstanceFactory, gitExportFactory} = __nccwpck_require__(3045);
...
const git_error_1 = __nccwpck_require__(1724);
/**
...
const debug_1 = __nccwpck_require__(7751);
const utils_1 = __nccwpck_require__(568);
...
const BranchDeleteSummary_1 = __nccwpck_require__(9968);
const utils_1 = __nccwpck_require__(568);
...
const BranchSummary_1 = __nccwpck_require__(1509);
const utils_1 = __nccwpck_require__(568);
const parsers = [
...
const DiffSummary_1 = __nccwpck_require__(6295);
...
const utils_1 = __nccwpck_require__(568);
const parse_diff_summary_1 = __nccwpck_require__(1194);
...
const MergeSummary_1 = __nccwpck_require__(3680);
const utils_1 = __nccwpck_require__(568);
const parse_pull_1 = __nccwpck_require__(1251);
const parsers = [
...
const PullSummary_1 = __nccwpck_require__(3252);
const utils_1 = __nccwpck_require__(568);
const parse_remote_messages_1 = __nccwpck_require__(2099);
...
const utils_1 = __nccwpck_require__(568);
const parse_remote_objects_1 = __nccwpck_require__(2811);
const parsers = [
...
const utils_1 = __nccwpck_require__(568);
const FileStatusSummary_1 = __nccwpck_require__(1175);
/**
...
const api_1 = __nccwpck_require__(8940);
const task_1 = __nccwpck_require__(1594);
const tasks_pending_queue_1 = __nccwpck_require__(8496);
const utils_1 = __nccwpck_require__(568);
...
const git_executor_chain_1 = __nccwpck_require__(8341);
class GitExecutor {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.gitP = void 0;
const git_response_error_1 = __nccwpck_require__(3595);
...
const { gitInstanceFactory } = __nccwpck_require__(3045);
function gitP(...args) {
    let git;
...
const utils_1 = __nccwpck_require__(568);
const promise_deferred_1 = __nccwpck_require__(1125);
const git_logger_1 = __nccwpck_require__(682);
...
const task_callback_1 = __nccwpck_require__(139);
const push_1 = __nccwpck_require__(7560);
const task_1 = __nccwpck_require__(1594);
const utils_1 = __nccwpck_require__(568);
class SimpleGitApi {
...
const git_response_error_1 = __nccwpck_require__(3595);
const parse_branch_delete_1 = __nccwpck_require__(4876);
const parse_branch_1 = __nccwpck_require__(3550);
...
const CheckIgnore_1 = __nccwpck_require__(119);
...
const CleanSummary_1 = __nccwpck_require__(4025);
const utils_1 = __nccwpck_require__(568);
const task_1 = __nccwpck_require__(1594);
...
const parse_commit_1 = __nccwpck_require__(3794);
...
const ConfigList_1 = __nccwpck_require__(6997);
...
const parse_fetch_1 = __nccwpck_require__(8416);
...
const InitSummary_1 = __nccwpck_require__(1964);
...
const parse_list_log_summary_1 = __nccwpck_require__(475);
const utils_1 = __nccwpck_require__(568);
var excludeOptions;
...
const api_1 = __nccwpck_require__(8940);
const parse_merge_1 = __nccwpck_require__(1846);
const task_1 = __nccwpck_require__(1594);
...
const parse_move_1 = __nccwpck_require__(2334);
const utils_1 = __nccwpck_require__(568);
...
const parse_push_1 = __nccwpck_require__(8543);
const utils_1 = __nccwpck_require__(568);
...
const GetRemoteSummary_1 = __nccwpck_require__(2083);
const task_1 = __nccwpck_require__(1594);
...
const parse_list_log_summary_1 = __nccwpck_require__(475);
const log_1 = __nccwpck_require__(7676);
...
const StatusSummary_1 = __nccwpck_require__(6211);
...
const TagList_1 = __nccwpck_require__(272);
/**
...
const task_configuration_error_1 = __nccwpck_require__(3211);
...
const util_1 = __nccwpck_require__(9187);
...
__exportStar(__nccwpck_require__(9299), exports);
__exportStar(__nccwpck_require__(9531), exports);
__exportStar(__nccwpck_require__(3738), exports);
__exportStar(__nccwpck_require__(7210), exports);
__exportStar(__nccwpck_require__(9408), exports);
__exportStar(__nccwpck_require__(1965), exports);
__exportStar(__nccwpck_require__(9187), exports);
//# sourceMappingURL=index.js.map
...
const argument_filters_1 = __nccwpck_require__(3798);
const util_1 = __nccwpck_require__(9187);
...
const file_exists_1 = __nccwpck_require__(9275);
const NOOP = () => {
};
exports.NOOP = NOOP;
/**
...
/******/ 	return __nccwpck_require__(3853);
/******/ })()
;